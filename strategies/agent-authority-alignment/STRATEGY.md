...
- lowercase `inputs/` references that should now be `Inputs/`
...
- Ensure runbooks and checklists use current path reality (`Inputs/`).
...
- Problem: mechanical `inputs/` -> `Inputs/` can modify historical text or intentional legacy examples.
