...
- Avoid changing `Inputs/` (read-only reference substrate).
...
5. **Execution stage**
- Persist final transcript in `Reports/` or a dedicated transcript artifact path.
...
`Project vocabulary: Mentci, mentci-aid, Aski, CriomOS, attractor, attractor-docs, Lojix, jj, Babashka, Malli, Inputs, Reports.`
