...
## 1. Overview
This document outlines the transition from the temporary **Gemini CLI** (running `gemini-3-flash-preview`) to the target **OpenCode CLI** (integrated with **DeepSeek-V4**). This shift completes the Level 5 agentic stack as defined in `RestartContext.md`.
