...
1.  **Strike 1:** The file is identified as potentially obsolete during a system sweep. It is added to `Outputs/Logs/OBSOLESCENCE_STRIKES.edn` with `strikes: 1`.
...
## 2. Tracking
Strikes are recorded in `Outputs/Logs/OBSOLESCENCE_STRIKES.edn` using the following schema:
