...
- [x] **Sandboxed Environment:** Implementation of the **Nix Jail** (`Components/nix/jail.nix` and `jail_launcher.py`).
...
- [ ] **Agent Communication Protocol:** Define Cap'n Proto RPCs for agent-to-agent talk (`Components/schema/mentci.capnp`).
