...
- `:solar` — governing, supreme-law, source-of-truth
- `:lunar` — mutable, stable-contract, implementation
...
## 6. Related Specs
- Aski DSL Guidelines: `Library/specs/AskiDslGuidelines.md`
- Aski-FS: `Library/specs/AskiFsDsl.md`
