...
## Objective
Classify every current subject category under `Strategies/` and `Reports/` into:
- `high`
- `medium`
- `low`

The classification is aligned to `Strategies/high/Repo-Intent-Realignment/STRATEGY.md`:
