...
1. Build `Interrupted Job Queue` artifact in the matching `Reports/<priority>/<Subject>/` topic.
...
2. `Reports/<priority>/<Subject>/README.md` indexes the new recovery artifacts.
...
- Generated queue artifact: `Reports/high/Prompt-Report-System/INTERRUPTED_JOB_QUEUE.md`
