...
1) Unified duplicate strategy/report subjects by collapsing `Commit-Protocol-Merge-Fanin-Strategy` into `Commit-Protocol-Merge-Fanin`, and `Sources-History-Purge-Strategy` into `Workspace-Pwd-History-Purge-And-Jj-Config-Migration`, moving report entries and deleting duplicate wrappers.
