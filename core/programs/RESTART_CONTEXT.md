...
- **Strategy System:** `strategies/<subject>/`. Status: **Operational.** Active: `artifact-sweep`, `aski-conversion`, `aski-refinement`, `attractor`, `debugging`, `mentci-rfs`, `project-hardening`, `strategy-development`.
