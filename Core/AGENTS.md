...
*   **Git Through JJ Rule:** In Mentci-AI and all of its components, we only use Git through JJ. Git may exist as backend transport/storage, but it must never replace JJ as workflow authority.
