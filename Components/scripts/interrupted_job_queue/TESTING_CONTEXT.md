...
- `bb Components/scripts/interrupted_job_queue/main.clj --source-report Research/high/Prompt-Report-System/591912042315_answer_interrupted-jobs-audit.md --output Research/high/Prompt-Report-System/INTERRUPTED_JOB_QUEUE.md --write`
- `bb Components/scripts/interrupted_job_queue/test.clj`

## Expected Result
- Dry run prints recovered prompt/job counts.
- `--write` creates/updates `Research/high/Prompt-Report-System/INTERRUPTED_JOB_QUEUE.md`.
