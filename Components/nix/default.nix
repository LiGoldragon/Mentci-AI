...
let
  ...
  fava_trails = pkgs.python3Packages.buildPythonApplication {
    pname = "fava-trails";
    version = "0.5.1";
    pyproject = true;
    nativeBuildInputs = [ pkgs.python3Packages.hatchling ];
    src = pkgs.fetchFromGitHub {
      owner = "MachineWisdomAI";
      repo = "fava-trails";
      rev = "v0.5.1";
      sha256 = "sha256-jqmIz7lD6XE6xUcOID8U02urkO4gLgNkz6CQA0DXnAI=";
    };
  ...
  fava_trails_mcp_server = pkgs.writeShellScriptBin "fava-trails-mcp-server" ''
    ${fava_trails}/bin/fava-trails
  '';
