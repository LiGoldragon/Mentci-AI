...
- [x] Reserve a local test port and define run workspace under `workspace/` or `Logs/`. (Used `127.0.0.1:38080`, artifacts in `Logs/`.)

- [x] Define the DOT job artifact.
- [x] Create a committed DOT file (for example `workflows/first_real_call.dot`) with explicit `start` and `exit` nodes.
...
- [x] Store payload in a tracked path (for example `Logs/attractor-first-call-request.json`).
...
- [x] Persist response body to `Logs/attractor-first-call-create-response.json`.
...
- [x] Add a short run summary to `docs/guides/RESTART_CONTEXT.md` (date, commit id, artifact paths).
...
- Request payload: `Logs/attractor-first-call-request.json`
- Server log: `Logs/attractor-first-call-server.log`
- Persisted responses:
  ...
  - `Logs/attractor-first-call-events.sse`
- SHA-256:
  - `workflows/first_real_call.dot`: `1714ddf4cdd0d768e93e55f740f99bc236a66e7109bb3258a3305875316dd266`
  - `Logs/attractor-first-call-request.json`: `9f6790a72b155d9a85d5bf2fee1099216ef5bb5a43455b185fbc2131e0e772d0`
  - `Logs/attractor-first-call-create-response.json`: `bc8543c3be41353cce83dcbeaed222c2ac7765da90be74e061190cee1bedc484`
