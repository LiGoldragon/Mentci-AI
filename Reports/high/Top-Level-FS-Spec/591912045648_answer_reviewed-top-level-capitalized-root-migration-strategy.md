...
Reviewed and revised `strategies/Top-Level-FS-Spec/STRATEGY.md`.
...
- Recommended migration order with concrete move map (including `strategies/` -> `Strategies/` and technical roots into `Components/`).
