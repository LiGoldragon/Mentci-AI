...
Ok I meant (main Sources [input] ...) then ... but can we turn Input into [input]? So we end up with (main Input ...) and 'input' is used in the function body (un-capitalized from the capitalized type name)?
