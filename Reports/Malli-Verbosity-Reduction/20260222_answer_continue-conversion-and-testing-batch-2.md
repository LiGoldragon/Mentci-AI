...
4. `Components/scripts/inputs_mounter/main.clj`
...
9. `Components/scripts/inputs_remount/main.clj`
...
- `bb Components/scripts/inputs_mounter/main.clj` -> pass
...
- `inputs_remount` -> fails due existing local `test.clj` helper not using `defn*` (pre-existing validator coupling)
