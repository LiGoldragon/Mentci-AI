...
1) Unified duplicate strategy/report subjects by collapsing `Commit-Protocol-Merge-Fanin-Strategy` into `Commit-Protocol-Merge-Fanin`, and `Inputs-History-Purge-Strategy` into `History-Inputs-Purge`, moving report entries and deleting duplicate wrappers.
