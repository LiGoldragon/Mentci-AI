...
- Updated `strategies/Workspace-Pwd-History-Purge-And-Jj-Config-Migration/STRATEGY.md` with a JJ-vs-Git capability matrix and explicit Git-unavoidable exceptions.
- Updated `strategies/Workspace-Pwd-History-Purge-And-Jj-Config-Migration/PLAYBOOK.md` with JJ-first execution policy, Git-exception boundaries, and post-rewrite `jj git import` + JJ-first publish sequence.
